...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Achizitii = __webpack_require__(84);
	...
	var _Sidebar = __webpack_require__(89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function initmap(judete) {
		...
		info.update = function (props) {
			this._div.innerHTML = '<h4>Data info</h4>' + (props ? '<b>' + props.name + '</b><br />' + props.diseaseValue + ' incidente' : 'Pune mouse-ul pe un judet');
		};
	...
	exports.default = {
		...
		mounted: function mounted() {
			initmap();
			var self = this;
			this.$http.get('/values/diseases').then(function (response) {
				// success callback
			...
			this.$http.get('/values/diseaseYears').then(function (response) {
				// success callback
		...
		methods: {
			...
			updateData: function updateData() {
				this.$http.get('/values/valueByDiseaseAndYear/' + this.selected + '/' + this.selectedYear).then(function (response) {
					// success callback
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-380ae688/Achizitii.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-3bbf70b4/Sidebar.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-18ac67d8/MainContent.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
